                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="input-group mb-6">
                                        ...
                                        <input type="text" class="form-control" name="texto" placeholder="Buscar producto" value="{{$searchText}}" aria-label="Recipient's username" aria-describedby="button-addon2">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $prod->stock}}</td>
                                    <td>
                                        <img src="{{ url('imagenes/productos/' . $prod->imagen) }}" alt="{{ $prod->nombre }}" height="70px" width="70px" class="img-thumbnail">
                                    </td>
